...
def resample_images(args):
    ...
    for fobj in filenames:
        try:
            ...
            # Nested double quotes inside an f-string are a 3.12 feature, and
            # this file is imported by a 3.11 interpreter here. Upstream never
            # noticed: Slicer 5.13 ships 3.12.
