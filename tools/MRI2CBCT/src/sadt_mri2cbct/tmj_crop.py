...
from .condyle_segmentation import segment_condyle, crop_with_affine
...
# ── MAIN ────────────────────────────────────────────────────────────
def crop_patients(cbct_folder, mri_folder, seg_folder, output_folder, model_folder, tmp_folder):
    """Upstream's `main(args)`, with the argparse namespace unpacked."""
    output_dir = Path(output_folder)
    tmp_folder = Path(tmp_folder)
    model_folder = Path(model_folder)

    patients = GetPatients(cbct_folder, mri_folder, seg_folder)
