...
from .approx_utils import get_corresponding_file, compute_rotation_correction, world_center_of_mass
...
def approximation(cbct_folder, mri_folder, output_folder, model_folder, tmp_folder):
    ...
    for patient_id, cbct_path, mri_path in pairs:
        ...
        patient_count += 1
        logger.info("Approximated %d/%d", patient_count, total_patients)
